...
remove_unwanted_packages() {
    local luci_packages=(
        ...
        "luci-app-msd_lite" "luci-app-unblockneteasemusic" "luci-app-dockerman" "luci-app-easytier"
        "luci-app-mosdns" "luci-app-pbr" "luci-app-wol"
    )
    local packages_net=(
    ...
    local small8_packages=(
        ...
        "alist" "opkg" "smartdns" "luci-app-smartdns" "luci-app-natmap" "webd"
    )
...
install_small8() {
    ./scripts/feeds install -p small8 -f xray-core xray-plugin dns2tcp dns2socks haproxy hysteria \
        ...
        luci-app-quickstart luci-app-istorex app-meta-istorex luci-app-cloudflarespeedtest netdata luci-app-netdata \
        lucky luci-app-lucky luci-app-openclash luci-app-homeproxy luci-app-amlogic nikki luci-app-nikki \
        tailscale luci-app-tailscale oaf open-app-filter luci-app-oaf cups luci-app-cupsd
    
    # 安装主题和配置插件
    ./scripts/feeds install -p luci -f luci-theme-argon luci-app-argon-config
}
