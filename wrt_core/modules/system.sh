...
fix_default_set() {
    ...
    # 安装主题配置文件
    if [ "$THEME_SET" = "istorex" ]; then
        install -Dm544 "$BASE_PATH/patches/990_set_istorex_primary" "$BUILD_DIR/package/base-files/files/etc/uci-defaults/990_set_istorex_primary"
    else
